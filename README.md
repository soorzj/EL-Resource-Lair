...
An independent, community-driven digital archive designed for Electrical & Computer (EL) students. This application serves as a de-centralized hub for academic resources, including reference texts, lecture notes, and previous year question papers and other stuff that are not otherwise fetched.

---

## 🏛 Motive & Background
Established as a student initiative starting 2026, the **EL Resource Lair** aims to bridge the gap between official administrative channels and the practical academic needs of students. In an environment where academic materials can often be scattered or difficult to locate, this Lair provides a structured, friction-less sanctuary for knowledge preservation and pursuit of excellence.
